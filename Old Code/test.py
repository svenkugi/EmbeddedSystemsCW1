...
while 1:
	...
	error_str += "object_temp calculated__"
	...
	error_str += "amb_temp calculated__"
	...
	error_str += "humidity calculated__"
	...
	error_str += "humidity averaged__"

	# TSL2561 (Brightness/Luminosity) Data 
	sensor = tsl2561.TSL2561(i2c)
	lux = sensor.read()

	error_str += "brightness calculated__"
	...
	error_str += "brightness averaged__"
	...
	error_str += "All sensor measurements calculated__"
